...
export const icons = [
  faFacebookF, faTwitter, faSkype, faMediumM, faLinkedinIn, faGooglePlusG, faPinterestP, faRedditAlien, faTumblr,
  faWhatsapp, faVk, faFacebookMessenger, faTelegramPlane, faStumbleupon, faXing, faDownload, faCommentAlt,
