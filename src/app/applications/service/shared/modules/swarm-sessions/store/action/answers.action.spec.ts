...
describe('Answers Actions', () => {
  ...
  it('Should create a CreateAnswer action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pkQuestion: 3, pkSession: 1,  data: {} };
  ...
  it('Should create a DeleteAnswer action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pkQuestion: 3, pkAnswer: 4, pkSession: 1 };
  ...
  it('Should create a UpdateAnswer action', () => {
    const payload = {
      pkTeam: 1, pkProject: 2, pkQuestion: 3, pkSession: 1, data: new FakeAnswerFactory().modelPropertiesCustom()};
