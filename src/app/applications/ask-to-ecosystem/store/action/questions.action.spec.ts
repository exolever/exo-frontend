...
describe('Questions Actions', () => {
  it('Should create a LoadQuestions action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pageIndex: 1, pageSize: 5 };
  ...
  it('Should create a CreateQuestion action', () => {
    const payload = { pkTeam: 1, pkProject: 2, data: {} };
  ...
  it('Should create a DeleteQuestion action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pkQuestion: 3 };
  ...
  it('Should create a SelectQuestion action', () => {
    const payload = {pkProject: 1, pkTeam: 2, pkQuestion: 3};
