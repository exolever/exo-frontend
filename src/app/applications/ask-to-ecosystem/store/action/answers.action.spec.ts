...
describe('Answers Actions', () => {
  it('Should create a LoadAnswers action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pkQuestion: 3, pageIndex: 1, pageSize: 5 };
  ...
  it('Should create a CreateAnswer action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pkQuestion: 3, data: {} };
  ...
  it('Should create a DeleteAnswer action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pkQuestion: 3, pkAnswer: 4 };
  ...
  it('Should create a UpdateAnswer action', () => {
    const payload = {
      pkTeam: 1, pkProject: 2, pkQuestion: 3, data: new FakeAnswerFactory().modelPropertiesCustom()};
  ...
  it('Should create a RateAnswer action', () => {
    const payload = { pkTeam: 1, pkProject: 2, pkQuestion: 3, pkAnswer: 4, rating: 1 };
